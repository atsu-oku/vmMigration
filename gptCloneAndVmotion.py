...
def prefix_to_subnet_mask(prefix_length):
    """CIDR繝励Ξ繝輔ぅ繝・け繧ｹ髟ｷ繧偵し繝悶ロ繝・ヨ繝槭せ繧ｯ縺ｫ螟画鋤縺吶ｋ"""
...
def calculate_ip_stg_to_prd(ip_address):
    """STG竊単RD蜷代￠縺ｫ隨ｬ荳峨が繧ｯ繝・ャ繝・170?179 繧・160?169 縺ｸ蜀吝ワ縺吶ｋ縲・

    - 蜈･蜉帙′遨ｺ縺ｪ繧・None 繧定ｿ斐☆
    - IPv4蠖｢蠑上→蜷・が繧ｯ繝・ャ繝医・遽・峇(0?255)繧呈､懆ｨｼ
    - 隨ｬ荳峨が繧ｯ繝・ャ繝医′ 170?179 縺ｪ繧・10 貂帷ｮ励＠縺ｦ霑斐☆
    - 縺昴ｌ莉･螟悶・蜑肴署螟悶→縺励※ ValueError 繧帝∝・
    """
    if not ip_address:
        return None
